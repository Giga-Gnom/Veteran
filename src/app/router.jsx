...
import UVAOorganization from "../components/Windows/MapWindow/DistrictWindows/UVAOWindow/UVAOorganization/UVAOrganization";
...
export const router = createBrowserRouter([
    ...
    },
    {
      ...
      element: <ZelAOWindow />
        ...
        {
      path: "/district/zelenograd/:areaID",
      element: <ZelAOorganization />
    },
    {
        ...
        {
        path: "/district/southwest/:areaID",
        element: <UZAOorganization />
    },
    {
        ...
        {
        path: "/district/southeast/:areaID",
        element: <UVAOorganization />
    },
    {
        path: "/district/south",
        element: <UAOWindow />
    ...
    {
        path: "/district/east/:areaID",
        element: <VAOorganization />
    },
    {
