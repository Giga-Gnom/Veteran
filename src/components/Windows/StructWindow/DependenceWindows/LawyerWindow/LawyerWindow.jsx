                ...
                <div className={styles.container_content_person}>
                    ...
                    <div className={styles.container_content_pesron_text}>
                        ...
                        <div className={styles.container_content_pesron_text_more}>
                            ...
                            <p>В газете «Московский ветеран» публикуются статьи с правовыми разъяснениями вопросов, которые являются наиболее насущными для пенсионеров и ветеранов города Москвы.</p>
                        </div>
                    </div>
                </div>
            </div>
