...
import personI from "./srcLawyer/фото Киселевой.jpg";
        ...
        <div className={styles.container}>
            ...
            <div className={styles.container_content}>
                <div className={styles.container_content_header}>
                    <h2>Сотрудники юридичекого отдела МГСВ</h2>
                </div>
                <div className={styles.container_content_person}>
                    ...
                    <div className={styles.container_content_pesron_text}>
                        ...
                        <h2>Киселева Наталья Викторовна</h2>
                        <div className={styles.container_content_pesron_text_more}>
                            <p>Осуществляет свою деятельность с ноября 2022 года.</p>
