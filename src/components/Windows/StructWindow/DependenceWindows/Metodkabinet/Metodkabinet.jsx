...
import miloserdova from "./miloserdova_2.png"
        ...
        <div className={styles.container}>
            ...
            <div className={styles.flex_row}>
                ...
                <div className={styles.container_content}>
                    ...
                    <p>Окончила МГЗПИ. Специальность - учитель географии.</p>
                    <p>Педагогический стаж более 50 лет. Учитель, заведующей учебной части, директор школы. Ветеран труда, Почетный учитель РФ, Отличник просвещения РФ, Заслуженный учитель РФ. Награждена - орденом "Знак Почёта", медалью "В память 850-летия Москвы"</p>
                    <br />
