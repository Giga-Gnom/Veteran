...
import styles from "./NovAOWindow.module.css";
import MyHat from "../../../../Hat/MyHat";
import { Link, useNavigate, useParams } from "react-router-dom";
import BeforePageButton from "../../../../UI/MyButtons/BeforePageButton";
import { districtsArray } from "../../districtsArray";
import knyazev from "./knyazev.png"
            ...
            <div className={styles.mapContainer}>
                ...
                <div className={styles.flex_column}>
                    <div className={styles.area_director_block}>
                        <img src={knyazev} alt="" className={styles.person_img}/>
                        <div className={styles.flex_column}>
                            <p><span style={{fontSize: "3vh"}}>Князев Георгий Иванович</span></p>
                            <p>Председатель Совета ветеранов Троицкого и Новомосковского административных округов города Москвы</p>
                            <p>Москва, ул. Сосенский стан, д.4, sv.tinao@yandex.ru</p>
                            <p>8-499-652-60-21; 8-499-652-60-23</p>
                        </div>
                    </div>
