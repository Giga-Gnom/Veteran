...
import dyablov from "./dyablov.png"
            ...
            <div className={styles.mapContainer}>
                ...
                <div className={styles.flex_column}>
                    <div className={styles.area_director_block}>
                        <img src={dyablov} alt="" className={styles.person_img}/>
                        <div className={styles.flex_column}>
                            <p><span style={{fontSize: "3vh"}}>Дяблов Николай Григорьевич</span></p>
                            <p>Председатель Совета ветеранов Южного административного округа города Москвы</p>
                            <p>Москва, ул. Автозаводская, д.17, корп.3; asovetveteranov@mail.ru </p>
                            <p>8-495-675-31-86; 8-495-675-04-82</p>
                        </div>
                    </div>
