...
import kurochkin from "./kurochkin.png"
        ...
        <div className={styles.container}>
            ...
            <div className={styles.mapContainer}>
                <div className={styles.mapContainer_map}>
                    <svg viewBox="360 35 220 600" className={styles.detailedMap}>
                ...
                <div className={styles.flex_column}>
                    <div className={styles.area_director_block}>
                        <img src={kurochkin} alt="" className={styles.person_img}/>
                        <div className={styles.flex_column}>
                            <p><span style={{fontSize: "3vh"}}>Курочкин Владимир Николаевич</span></p>
                            <p>Председатель Совета ветеранов Северного административного округа города Москвы</p>
                            <p>Москва, Астрадамский пр., д.4, корп. 1, sovet-sao2013@yandex.ru</p>
                            <p>8-495-611-73-45, 8-495-611-56-79</p>
                        </div>
                    </div>
